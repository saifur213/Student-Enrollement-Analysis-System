        ...
        <div id="layoutSidenav_content">
          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              ...
              <div class="card-body">
              <form action="php/course.php" method="POST" id="course-form">
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Course Id</label>
                        <input type="text" class="form-control"  placeholder="Ex. CSE101" name="course_id">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Course Name</label>
                        <input type="text" class="form-control"  placeholder="Ex. Introduction to Computer Science" name="course_name">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-7 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ex. 3" name="course_credit">
                      </div>
                    </div>
              ...
              <div class="card-footer" align="center">
                <button type="button" class="btn btn-primary submit-button">Add Course</button>
              </div>
            </div>
          </div>
                    </div>
