          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              ...
              <div class="alert alert-success" <?php if(isset($_GET['response']) && $_GET['response'] == 200){}else{echo "hidden";} ?>>
                ...
                <span><b> School Added Successfully.</span>
              </div>
              ...
              <div class="alert alert-danger" <?php if(isset($_GET['response']) && $_GET['response'] == 501){}else{echo "hidden";} ?>>
                ...
                <span><b> Failed to add school.</span>
              </div>
              <div class="card-header">
                <h4 class="card-title">New school</h4>
              </div>
              <div class="card-body">
              <form action="php/school.php" method="POST" id="program-form">
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>School Id</label>
                        <input type="text" class="form-control"  placeholder="Ex. SETS" name="school_id">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>School Title</label>
                        <input type="text" class="form-control"  placeholder="Ex. School of Engineering" name="school_title">
                      </div>
                    </div>
