          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              ...
              <div class="alert alert-success" <?php if(isset($_GET['response']) && $_GET['response'] == 200){}else{echo "hidden";} ?>>
                ...
                <span><b> Faculty Added Successfully.</span>
              </div>
              ...
              <div class="alert alert-danger" <?php if(isset($_GET['response']) && $_GET['response'] == 501){}else{echo "hidden";} ?>>
                ...
                <span><b> Failed to add Faculty.</span>
              </div>
              <div class="card-header">
                <h4 class="card-title">New Faculty</h4>
              </div>
              <div class="card-body">
              <form action="php/faculty.php" method="POST" id="program-form">
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Faculty Id</label>
                        <input type="text" class="form-control"  placeholder="Ex. FF1" name="faculty_id">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Faculty Name</label>
                        <input type="text" class="form-control"  placeholder="Ex. MD. Abu Sayed" name="faculty_title">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="text" class="form-control"  placeholder="Ex. CSE" name="faculty_email">
                      </div>
                    </div>
              ...
              <div class="card-footer" align="center">
                <button type="button" class="btn btn-primary submit-button">Add School</button>
              </div>
            </div>
          </div>
                    </div>
