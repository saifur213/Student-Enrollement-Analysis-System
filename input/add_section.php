          ...
          <div class="col-lg-12">
            <div class="card card-chart">
              ...
              <div class="alert alert-success" <?php if(isset($_GET['response']) && $_GET['response'] == 200){}else{echo "hidden";} ?>>
                ...
                <span><b> Section Added Successfully.</span>
              </div>
              ...
              <div class="alert alert-danger" <?php if(isset($_GET['response']) && $_GET['response'] == 501){}else{echo "hidden";} ?>>
                ...
                <span><b> Failed to add Section.</span>
              </div>
              <div class="card-header">
                <h4 class="card-title">New Section</h4>
              </div>
              <div class="card-body">
              <form action="php/section.php" method="POST" id="program-form">
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>CSSY ID</label>
                        <input type="text" class="form-control"  placeholder="Ex. 1" name="section_no">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ex. Spring" name="section_semsetr">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ex. 2022" name="section_yr">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Course Id</label>
                        <input type="text" class="form-control"  placeholder="Ex. 30" name="section_cap">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Faculty Id</label>
                        <input type="text" class="form-control"  placeholder="Ex. 25" name="section_en">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Ex. y" name="section_bloc">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Enrolled</label>
                        <input type="text" class="form-control"  placeholder="Ex. 8.00" name="section_st">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Semester</label>
                        <input type="text" class="form-control"  placeholder="Ex. 9.30" name="section_et">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Year</label>
                        <input type="text" class="form-control"  placeholder="Ex. ST" name="section_day">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Section Time</label>
                        <input type="text" class="form-control"  placeholder="Ex. BC4001" name="section_room">
                      </div>
                    </div>
              ...
              <div class="card-footer" align="center">
                <button type="button" class="btn btn-primary submit-button">Add Section</button>
              </div>
            </div>
          </div>
                    </div>
